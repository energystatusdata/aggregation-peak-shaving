...
battery_load = optimization_result.P_c - optimization_result.P_d;
plot(input_timeseries.Time * 24, battery_load, ...
    'Color', [223 155 27] / 255);%[163 16 124] / 255);
...
[hh,icons,plots,txt] = legend({'load', 'battery', 'shaved'},...
    'interpreter', 'latex',...
    'FontSize', 7,...
    'FontName', 'Linux Libertine',...
    'Location', 'NorthEast',...
    'Position', [.7815 .805 0 0]);
    %'Position', [.7815 .295 0 0]);
