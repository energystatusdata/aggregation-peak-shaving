classdef SamplingManipulator_Averaging < TimeseriesManipulator
    properties
        window_size_in_seconds
    end
    
    methods
        function obj = SamplingManipulator_Averaging(window_size_in_seconds)
    ...
    methods (Access = private)
        ...
        function [output_ts] = resampleTimeseries(obj, inputTimeseries)
            ...
            upsampled.Data = movmean(upsampled.Data, floor(window_size));
            time_vector = (0:(1/24/60/60)*obj.window_size_in_seconds:end_of_time);
            output_ts = resample(upsampled, time_vector);
        end
    end
end
